...
RUN rm -rf /ComfyUI/models/diffusion_models && \
    ...
    ln -s /runpod-volume/I2V_4steps/diffusion_models /ComfyUI/models/diffusion_models && \
    ln -s /runpod-volume/I2V_4steps/loras /ComfyUI/models/loras && \
    ln -s /runpod-volume/I2V_4steps/text_encoders /ComfyUI/models/text_encoders && \
    ln -s /runpod-volume/I2V_4steps/vae /ComfyUI/models/vae
